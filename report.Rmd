```{r}
# - dodati za vreme raspodelu, to ce biti ravna linija na primer za gustinu rapsodele
# - sta izaberes kao metriku za performanse, samo moras da objasnis zbog cega (zasto je to bitno da se racuna)
# - prikazivanje odnosa performansi moze da se odradi i preko barplota, pa da se prikaze sve na jednom dijagramu cak
...
ggarrange(plot_min_instances_per_node_acc,
...
```{r Clusters structure examination}
cluster_k_6
cluster_k_12
```


```{r Preparing unormalized table for clustering visualization}
...
#### k = 6
```{r Value vs cluster belonging visualisation 6}
